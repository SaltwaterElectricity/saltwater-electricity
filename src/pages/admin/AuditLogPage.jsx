                  ...
                  <tr key={log.id} className="group hover:bg-white/40 transition-all duration-300">
                    ...
                    <td className="px-8 py-6">
                      <span className="text-[11px] font-mono font-bold text-slate-500">
                        #{log.targetId?.substring(0, 8).toUpperCase()}
                      </span>
                    </td>
                    <td className="px-8 py-6">
                      <p className="text-[11px] font-medium text-slate-600 truncate max-w-xs">
                        {log.details}
                      </p>
                    </td>
                    <td className="px-8 py-6">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {isSuperAdmin ? (
                          ...
                          <button className="flex items-center gap-2 px-4 py-2.5 bg-slate-100 text-slate-600 rounded-xl hover:bg-white hover:text-blue-600 transition-all active:scale-95 font-black text-[9px] uppercase tracking-widest border border-slate-200/50">
