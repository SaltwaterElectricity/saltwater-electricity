      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="relative shrink-0">
          ...
          >
            ...
            <span className="text-sm font-semibold text-on-surface">Real-time Analysis</span>
          ...
          {showCalendarPlaceholder && (
            <div className="absolute right-0 top-full mt-2 p-4 bg-white rounded-xl shadow-2xl border border-outline-variant/20 z-50 w-64 animate-in fade-in slide-in-from-top-2">
              ...
              <p className="text-[10px] text-outline leading-relaxed">
                The advanced date picker is being synchronized with the facility&apos;s local time
                server. Currently showing the latest 24 hours of telemetry.
              </p>
              <button
      ...
      <div className="h-[320px] w-full relative bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px] flex-1">
        {data.length === 0 ? (
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-xs font-bold text-outline uppercase tracking-widest animate-pulse">
              Synchronizing Data...
            </p>
          </div>
        ) : (
