      ...
      <>
        ...
        >
          ...
          <div className="flex flex-col items-center text-center animate-in fade-in duration-500">
            ...
            <p className="text-[10px] font-bold text-blue-500 tracking-[0.5px] mt-1 uppercase">Saltwater Electricity</p>
          </div>
        </div>
...
const AdminNav = memo(({ isExpanded, isAdmin, userRole, unreadCount, handleLinkClick }) => (
  <nav className={cn(
    ...
    <div className={cn("pt-4 pb-2 transition-all", !isExpanded && "opacity-0 h-0 p-0 overflow-hidden")}>
      <p className="px-4 text-[11px] font-black text-slate-500 uppercase tracking-[2px]">Operations</p>
    </div>
