...
import { X, Activity, History, Table as TableIcon, UserCheck, Zap, Download } from "lucide-react";
...
const SectionHeader = ({ title, sub }) => (
  <div className="mb-8">
    <h3 className="text-base md:text-lg font-black text-slate-900 tracking-tight uppercase leading-none font-['Space_Grotesk']">
      {title}
    </h3>
    <p className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-2 font-['Inter']">
      {sub}
    </p>
  </div>
);
