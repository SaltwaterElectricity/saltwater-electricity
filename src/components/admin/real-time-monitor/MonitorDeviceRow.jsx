  ...
  <div className="w-40 group/reading">
    <div className="flex flex-col mb-2">
      ...
      <div className="flex items-baseline space-x-1">
        <span className="text-sm font-bold text-slate-900 group-hover/reading:text-primary transition-colors">{value}{unit}</span>
      </div>
    </div>
      ...
      {[
        ...
        <div 
          ...
          className={cn(
            ...
            color === 'blue' ? "bg-blue-100 group-hover/reading:bg-primary" : "bg-purple-100 group-hover/reading:bg-purple-600"
          )} 
    ...
    <div className="bg-white px-6 py-4 rounded-[20px] border border-gray-100 flex items-center shadow-sm hover:shadow-md transition-all duration-300 group h-[110px]">
      ...
      <div className="w-[30%] flex items-center space-x-4 pr-6 border-r border-gray-100 h-full">
        <div className={cn(
          ...
          device.isOnline ? "bg-blue-50 text-primary border-blue-100" : "bg-slate-50 text-slate-300 border-slate-100"
        )}>
          <Server className="h-6 w-6" />
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2 mb-0.5">
            <span className="font-bold text-slate-900 truncate tracking-tight">{device.device_id}</span>
            <span className={cn(
          ...
          <p className="text-xs font-semibold text-slate-500 truncate italic">{device.residentName}</p>
