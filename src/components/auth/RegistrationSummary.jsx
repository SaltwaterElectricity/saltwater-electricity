...
>>>>>>> c81ec3273035eaedf93d36882c4b5ed75935f31a
      ...
      <div className="grid grid-cols-2 gap-8">
        <div>
<<<<<<< HEAD
          <h3 className="text-[11px] font-black uppercase text-slate-400 tracking-widest mb-3">
            Profile Details
          </h3>
...
<<<<<<< HEAD
          * Confirming this will trigger an automated onboarding email containing the
          system-generated credentials to the email address provided above.
=======
