...
const SidebarLink = memo(
  ({ to, icon: Icon, label, onClick, badgeCount, badgeColor = "bg-red-500" }) => (
    <NavLink
      to={to}
      ...
      >
        ...
        <nav className="flex-1 px-4 py-8 space-y-10 overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-2">
            <p className="text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] px-4 mb-4">
              Analytics
            </p>
            <SidebarLink
              to={ROUTES.DASHBOARD}
            ...
            <SidebarLink
              ...
              label="System Alerts"
              onClick={handleLinkClick}
              badgeCount={alertCounts.systemAlerts}
            />
            <SidebarLink
              to="/history"
              icon={History}
