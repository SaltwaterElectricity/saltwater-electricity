  ...
  return (
    <div className="space-y-stack-lg animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-white rounded-2xl p-6 flex items-center shadow-sm border border-slate-100 h-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
        {[1, 2].map((i) => (
          <div key={i} className="bg-white rounded-2xl p-6 h-[400px] shadow-sm border border-slate-100 flex flex-col">
