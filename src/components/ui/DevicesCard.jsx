...
const DevicesCard = ({ mac, data, active }) => {
  ...
  return (
    <div
      className={`p-5 rounded-[2rem] border transition-all duration-300 shadow-sm group ${
        active
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="overflow-hidden">
          <h3
            className={`font-black text-[10px] truncate uppercase tracking-widest ${
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-slate-50/50 p-2 rounded-xl border border-slate-100/50">
          ...
          <span
            className={`text-sm font-black ${!isOnline ? "text-slate-400" : "text-orange-500"}`}
          >
            {displayTemp}°C
          </span>
        </div>
