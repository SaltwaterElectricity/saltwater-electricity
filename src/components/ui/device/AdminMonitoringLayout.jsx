...
export const AdminMonitoringLayout = ({ device, telemetry }) => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <button className="group w-full h-12 bg-slate-900 text-white rounded-2xl font-black text-[10px] tracking-[0.2em] uppercase transition-all hover:bg-blue-600 flex items-center justify-center gap-2">
        <Activity size={14} />
        Full System Audit
