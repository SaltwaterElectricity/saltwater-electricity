      ...
      <div className="overflow-x-auto custom-scrollbar-hide">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-outline-variant/10">
            {users.map((user, index) => (
              <tr key={user.uid || index} className="hover:bg-primary/5 transition-colors group">
                ...
                <td className="px-8 py-4 text-[11px] text-outline">
                  {user.assignedAt ? new Date(user.assignedAt).toLocaleDateString() : "APRIL 12, 2025"}
                </td>
            ...
            {loading && (
              <tr>
                <td colSpan="5" className="px-8 py-12 text-center text-[11px] font-bold text-outline animate-pulse uppercase tracking-[0.2em]">
            ...
            {!loading && users.length === 0 && (
              <tr>
                <td colSpan="5" className="px-8 py-12 text-center text-[11px] font-bold text-outline uppercase tracking-[0.2em]">
