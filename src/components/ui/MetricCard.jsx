  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col min-h-[180px] relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        {trendValue && (
          <div className={cn(
            ...
            <span className="material-symbols-outlined text-[14px]">
              {trend === "up" ? "arrow_drop_up" : trend === "down" ? "arrow_drop_down" : "trending_flat"}
            </span>
            {trendValue}
          </div>
        )}
      ...
      <div className="mt-4">
        ...
        <h2 className="text-4xl font-extrabold text-on-surface mt-1 tracking-tight">
          {value}
        </h2>
      </div>
        ...
        {isHealth ? (
          <>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <span className={cn("text-[11px] font-bold", colorClass)}>{statusValue || "Optimal"}</span>
            </div>
