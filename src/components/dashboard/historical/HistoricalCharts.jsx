    ...
    return [
      {
        ...
        color: "#003594",
        percent: ((totals.voltage / totalAll) * 100).toFixed(1),
      },
      {
        name: "Salinity",
        value: totals.salinity,
        color: "#0891b2",
        percent: ((totals.salinity / totalAll) * 100).toFixed(1),
      },
      {
        name: "Current",
        value: totals.current,
        color: "#ea580c",
        percent: ((totals.current / totalAll) * 100).toFixed(1),
      },
    ];
  }, [logs]);
      ...
      <div className="lg:col-span-8 bg-white p-lg rounded-xl border border-outline-variant shadow-sm flex flex-col min-h-[450px]">
        <div className="flex justify-between items-center mb-lg">
          <div>
            ...
            <p className="text-body-sm text-secondary">
              Voltage, salinity, and current readings over time.
            </p>
          </div>
        ...
        <div className="flex items-center gap-lg mb-md">
          <label className="flex items-center gap-2 cursor-pointer group">
            ...
            />
            <span className="text-body-sm text-secondary group-hover:text-primary transition-colors">
              Current (A)
            </span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer group">
            ...
            />
            <span className="text-body-sm text-secondary group-hover:text-primary-fixed-dim transition-colors">
              Voltage (V)
            </span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer group">
            ...
            />
            <span className="text-body-sm text-secondary group-hover:text-severity-info transition-colors">
              Salinity (ppm)
            </span>
          </label>
        </div>
      ...
      <div className="lg:col-span-4 space-y-lg">
        ...
        <div className="bg-white rounded-xl border border-outline-variant shadow-sm p-md border-primary h-full">
          ...
          <div className="flex items-center gap-md">
            ...
            <div className="relative w-32 h-32">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <p className="text-[10px] text-outline uppercase tracking-tighter leading-none">
                  Total
                </p>
          ...
          <div className="mt-lg pt-lg border-t border-outline-variant/30">
            <h5 className="text-label-caps text-secondary uppercase tracking-wider mb-md">
