      ...
      <div className="flex-1 relative">
        {logsLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full opacity-50 text-center animate-in fade-in duration-500">
            ...
            <p className="text-[11px] font-medium text-outline mt-1">Check your request status for pending hardware.</p>
          </div>
        ) : logs.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full opacity-50 text-center animate-in fade-in duration-500">
            ...
            <p className="text-[11px] font-medium text-outline mt-1">History is recorded when devices are active and sending telemetry.</p>
          </div>
        ) : (
