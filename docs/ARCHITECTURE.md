...
1.  **Strict Masking**: Specific credential errors (like "wrong-password" vs "user-not-found") are combined into a generic _"Invalid email or password"_ notification to prevent account enumeration.
